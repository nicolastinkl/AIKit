...
@property (nonatomic, strong) NSURL * _Nullable targetURL;
...
@property (nonatomic, strong) NSDictionary * _Nullable appLinkData;
@property (nonatomic, strong) NSURL * _Nullable referrerTargetURL;
@property (nonatomic, strong) NSURL * _Nullable referrerURL;
@property (nonatomic, copy) NSString * _Nullable referrerAppName;
...
+ (NSArray * _Nonnull)namedGroupsForString:(NSString * _Nonnull)str;
@end
